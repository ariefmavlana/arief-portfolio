    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Per Tecnología nos Universum Regimus</h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            I Specialize in creating high-quality websites and applications. From design to deployment, I can help you build your online presence. Lets get started!
          </p>
        </div>
